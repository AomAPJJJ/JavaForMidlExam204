...
import sit.int204.classicmodelsprac.repositories.OfficeRepository;
...
public class OfficeService {
    ...
    @Transactional
    public Office updateOffice(String officeCode, Office office) { if(office.getOfficeCode()!=null && !office.getOfficeCode().trim().isEmpty()) {
